...
ggplot(aes(x=Decile,y=Corr)) + 
  ...
  geom_smooth(aes(fill=condit),method = "lm") + 
 labs(y="CatLearn Accuracy", x="Similarity Rating Decile", fill="Training Condition")
